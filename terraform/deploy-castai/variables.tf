...
# CastAI API Key
# This should be set via environment variable TF_VAR_castai_api_key
# or passed securely (never commit to version control)
variable "castai_api_key" {
  description = "CastAI API key for cluster management"
  type        = string
  sensitive   = true
}